...
const ProductsData = () => {
  ...
  return (
    <div className="p-6 bg-gray-100 min-h-screen flex flex-col lg:flex-row gap-8 justify-center">
      <motion.div
        initial={{ opacity: 0, x: -80 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{ duration: 0.7 }}
        className=" p-6 w-full max-w-lg sticky top-20 h-fit"
      >
        {/* Big Image */}
        <img
          src={selectedImage}
          alt="Product"
          className="w-full h-96 object-contain border rounded border-gray-300"
        />
      ...
      >
        ...
        <div className="flex items-center text-sm gap-2 mt-2">
          ...
          <span className="text-gray-500">(2,340 ratings & 320 reviews)</span>
        </div>
        ...
        <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded">
          <p className="font-semibold">Warrenty</p>
          ...
          {review.map((item, index) => (
            ...
            >
              <div className="flex items-center gap-2">
                ...
                <p className="text-gray-700 font-medium">{item.reviewerName}</p>
              </div>
