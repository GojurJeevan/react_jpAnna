              ...
              >
                ...
                <div className="relative flex h-full flex-col overflow-y-auto bg-white py-6 shadow-xl after:absolute after:inset-y-0 after:left-0 after:w-px after:bg-white/10">
                  <div className="px-4 sm:px-6">
                    <DialogTitle className="font-semibold text-2xl">User Details</DialogTitle>
                  </div>
                  <div className="relative mt-6 flex-1 px-4 sm:px-6">
                    <form>
                       <div>
                            <input type="text" placeholder='FirstName'className='border my-3'/> <br />
                            <input type="email" placeholder='Email' className='border my-3'/> <br />
                            <input type="mobile" placeholder='Mobile' className='border my-3'/> <br />
                            <input type="text" placeholder='Gender' className='border my-3'/>
                       </div>
                    </form>
                    <button className='bg-green-500 cursor-pointer p-1 my-2'>Save Edit</button>
                  </div>
                </div>
              </DialogPanel>
            </div>
